...
namespace CharacterCustomization
{
    ...
    public class Appearance
    {
        ...
        public Appearance(string faceshape, string eyeshape, string eyecolor, string eyebrowshape, string noseshape, string mouthshape,
            string earshape, string facialhair, string hairstyle, string accessory, string bodytype)
        {
            ...
            /*this.faceShape = "Hello";
            this.eyeShape = "Hello";
            this.eyeColor = "Hello";
            this.eyebrowShape = "Hello";
            this.noseShape = "Hello";
            this.mouthShape = "Hello";
            this.earShape = "Hello";
            this.facialHair = "Hello";
            this.hairstyle = "Hello";
            this.accessory = "Hello";
            this.bodyType = "Hello";*/
    ...
    public class CustomAppearance : CheckForErrors, IShowOps
    {
        ...
        {
            string hairstyle11 = "", hairstyle22 = "", hairstyle33 = "", hairstyle44 = "", hairstyleI, input;
